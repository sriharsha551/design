...
class Invoice_model extends CI_Model
{
    ...
    {
        $this->db->select('t1.*,t2.name as invoice_status,t3.ponumber as order_name,t4.name as supplier,t5.name as cr_days,t6.name as tax,t7.item_name as invoice_item');
