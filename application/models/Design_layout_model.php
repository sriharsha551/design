...
class Design_layout_model extends CI_Model {
    ...
    function get_all_design_layout($params = array())
    {
        ...
        $this->db->select('t1.name as layout_name, t2.name as proj_name, t1.id, t3.design_stage, t1.attach_name, t1.percentage, t1.review_status, t1.revisions, t1.remarks, t4.review_status_name');    
