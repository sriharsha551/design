			...
			<div class="card-body"> 
				<div class="box-body"> 
					...
					<div class="row clearfix">
						<div class="col-md-6">
							<label for="name" class="form-label"><span class="text-danger">*</span>Account COA Name</label>
						...
						<div class="col-md-6">
                            ...
                            <select name="coa_cat_id" class="form-control">
								...
								<?php foreach ($cat_list as $cat) { ;?>
									<option value="<?php echo $cat['id'];?>" <?php echo $this->input->post('coa_cat_id') == $cat['id'] ? 'selected="selected"' : ""; ?>>
										<?php echo $cat['name'];?>
									</option>
								<?php } ?>
                            </select>
