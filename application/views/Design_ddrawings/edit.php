                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name"
                                    value="<?php echo $this->input->post('name') ?  $this->input->post('name') : $design_ddrawings['name']; ?>"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="percentage"
                                    value="<?php echo $this->input->post('percentage') ? $this->input->post('percentage') : $design_ddrawings['percentage']; ?>"
