					...
					<div class="row clearfix">
						<div class="col-md-6">
                            ...
                            <select name="prj_id" class="form-control" id="prj_id">
                                ...
                                <option value="<?php echo $proj['id'] ?>" <?php echo ($design_ddrawings['prj_id'] == $proj['id']) ? 'selected="selected"' : "" ?> ><?php echo $proj['name'] ?></option>
                                <?php } ?>
                            </select>
                            </div>
							<div class="form-group">
                                <label for="name" class="form-label"><span class="text-danger">*</span>Name</label>
								<input type="text" name="name" value="<?php echo $this->input->post('name') ?  $this->input->post('name') : $design_ddrawings['name']; ?>" class="form-control" id="name" />
                            ...
                            <select name="design_stage_id" class="form-control" id="design_stage_id">
                                ...
                                <option value="<?php echo $design_stage['id'] ?>" <?php echo ($design_ddrawings['design_stage_id'] == $design_stage['id']) ? 'selected="selected"' : "" ?> ><?php echo $design_stage['design_stage'] ?></option>
                                <?php } ?>
                            </select>
                            </div> -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
								...
								<input type="text" name="percentage" value="<?php echo $this->input->post('percentage') ? $this->input->post('percentage') : $design_ddrawings['percentage']; ?>" class="form-control" id="percentage" />
