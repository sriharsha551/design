<!-- Layout container -->
<div class="layout-container"><!-- end tag is in footer.php -->
        <!-- Layout navbar -->
            ...
            <div class="navbar-nav align-items-lg-center ml-auto">
              ...
              <div class="demo-navbar-messages nav-item dropdown mr-lg-3">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <div class="list-group list-group-flush">
                    <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                      <img src="<?php echo base_url($assets_dir); ?>/img/avatars/6-small.png" class="d-block ui-w-40 rounded-circle" alt>
                    ...
                    <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                      <img src="<?php echo base_url($assets_dir); ?>/img/avatars/4-small.png" class="d-block ui-w-40 rounded-circle" alt>
                      <div class="media-body ml-3">
                    ...
                    <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                      <img src="<?php echo base_url($assets_dir); ?>/img/avatars/5-small.png" class="d-block ui-w-40 rounded-circle" alt>
                      <div class="media-body ml-3">
                        <div class="text-body line-height-condenced">Sit meis deleniti eu, pri vidit meliore docendi ut.</div>
                        <div class="text-light small mt-1">
                    ...
                    <a href="javascript:void(0)" class="list-group-item list-group-item-action media d-flex align-items-center">
                      <img src="<?php echo base_url($assets_dir); ?>/img/avatars/11-small.png" class="d-block ui-w-40 rounded-circle" alt>
                      <div class="media-body ml-3">
              ...
              <div class="demo-navbar-user nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                  <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                    <img src="<?php echo base_url($assets_dir); ?>/img/avatars/1.png" alt class="d-block ui-w-30 rounded-circle">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <a href="<?php echo base_url(); ?>auth/logout" class="dropdown-item"><i class="ion ion-ios-log-out text-danger"></i> &nbsp; Log Out</a>
                </div>
              </div>
            </div>
          </div>
