		...
		<div class="card mb-4">
           <h6 class="card-header">ADD</h6>
			<div class="card-body">
				...
				<?php echo form_open('Leave_type/add',array("class"=>"form")); ?>
<div class="box-body">
							<div class="row clearfix">
					<div class="col-md-6">
						<label for="leaveType" class="form-label"><span class="text-danger">*</span>Leave Type</label>
						<div class="form-group">
							<input type="text" name="leaveType" value="<?php echo $this->input->post('leaveType'); ?>" class="form-control" id="leaveType" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="noOfLeaves" value="<?php echo $this->input->post('noOfLeaves'); ?>" class="form-control" id="noOfLeaves" />
