				...
				<table class="datatables-demo table table-striped table-bordered">
					...
					<tr>
						...
						<td><?php if($i['offer_letter_generated_on']!="")
                            {
                                echo "<a title='View Offer Letter' target='_blank' href='".base_url()."pdf/offerLetter/offerLetter_".$i['id'].".pdf'>".date("d-m-Y", strtotime($i['offer_letter_generated_on']))."</a>"; 
                            } 
                            else    echo ""; ?></td>
						<td>							
							<a href="<?php echo site_url('Employee/view/'.$i['id']); ?>" class="btn btn-info btn-xs mr-1"><span class="fas fa-eye"></span></a>
							<a target="_blank" href="<?php echo site_url('Createpdf/generateOfferLetterPDF/' . $i['id']); ?>" class="btn btn-danger btn-xs mr-1"><span class="fas fa-print"></span></a>
						</td>
					</tr>
					<?php } ?>
