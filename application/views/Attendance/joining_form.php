        ...
        <div class="card-body">
            ...
            <form action="" method="post" class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="email" class="form-control" placeholder="Email" name="empName" value="" required>
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea class="form-control" placeholder="Present Address" name="presentAddress"></textarea>
                </div>
                <div class="form-group col-md-6">
                    <label class="form-label">Permanent Address</label>
                    <textarea class="form-control" placeholder="Permanent Address" name="permanentAddress"></textarea>
                </div>
                <div class="form-group col-md-6">
