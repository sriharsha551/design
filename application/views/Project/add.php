	...
	<div class="container-fluid flex-grow-1 container-p-y">
		...
		<div class="card mb-4">
         <h6 class="card-header">ADD</h6>
			<div class="card-body">
				 <div class="col-md-12">
                <?php echo form_open('project/add',array("class"=>"form-row row")); ?>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="">
                            <input type="text" name="project" value="<?php echo $this->input->post('project'); ?>" class="form-control" id="project" />
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="">
                            <input type="text" name="client" value="<?php echo $this->input->post('client'); ?>" class="form-control" id="client" />
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="">
                            <input type="text" name="enquiry_no" value="<?php echo $this->input->post('enquiry_no'); ?>" class="form-control" id="enquiry_no" />
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="">
                            <input type="text" name="project_no" value="<?php echo $this->input->post('project_no'); ?>" class="form-control" id="project_no" />
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="c">
                            <input type="text" name="mobile1" value="<?php echo $this->input->post('mobile1'); ?>" class="form-control" id="mobile1" />
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="">
                            <input type="text" name="mobile2" value="<?php echo $this->input->post('mobile2'); ?>" class="form-control" id="mobile2" />
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="">
                            <input type="text" name="project_date" value="<?php echo $this->input->post('project_date'); ?>" class="form-control" id="datepicker-inline" />
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="">
                            <textarea name="discription" class="form-control" id="discription"><?php echo $this->input->post('discription'); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group col-md-6">
